...
function FileTreeDirectory({
  ...
  changes: ReadonlyMap<string, "added" | "modified" | "deleted">
...
function FilesSurface({
  ...
  files: ReadonlyArray<string>
  fileChanges: NonNullable<WorkspaceShellProps["fileChanges"]>
  onReadFile?: (path: string) => Promise<WorkspaceFileContentView>
}) {
...
function WorkspaceShell({
  ...
  const promptError =
    commandError?.command === "review" || commandError?.command === "deploy"
      ? null
      : workspaceCommandErrorExcept(commandError, "review")
