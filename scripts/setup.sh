...
say "Create the OAuth application users will use to authenticate with this Installation."
open_url "https://github.com/settings/applications/new"
step "Set Application name to a name that identifies this Sylph Installation."
step "Set Homepage URL to $SYLPH_URL"
step "Set Authorization callback URL to $SYLPH_URL/api/auth/callback/github"
step "Create the application, then copy its Client ID."
