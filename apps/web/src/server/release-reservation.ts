...
INSERT INTO deployment (id, project_id, [commit], status, actor_user_id, base_deployment_id, recovery_deployment_id, managed_release, capture_evidence, created_at, updated_at)
SELECT ?, ?, ?, 'queued', ?, ?, ?, ?, ?, ?, ?
...
SELECT d.[commit], d.recovery_deployment_id, d.managed_release, d.capture_evidence,
